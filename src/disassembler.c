...
void fileProcessor(char *fileInput) {
    ...
    unsigned char *programCode = malloc(fileSize);

    FILE *fp = fopen(fileInput, "rb");

    fread(programCode, fileSize, 1, fp);
    fclose(fp);
    printf("File Size: %ld\n", fileSize);
    programBuffer = programCode;
}


int disassembleToConsole() {
    int opbytes = 1;
    unsigned char *code = &programBuffer[pc];
    switch (*code) {
        ...
        case 0x16: printf("MVI   E, #0x%02x", code[1]); opbytes = 2; break;
        ...
        case 0x2d: printf("DCP   L"); break;
        case 0x2e: printf("MVI   L, #0x%02x", code[1]); opbytes = 2; break;
        case 0x2f: printf("DAA"); break;
        case 0x30: printf("NOP"); break;
        case 0x31: printf("LXI   SP, #0x%02x%02x", code[2], code[1]); break;
        ...
        case 0x91: printf("SUB   A"); break;
        case 0x92: printf("SUB   B"); break;
        case 0x93: printf("SUB   C"); break;
        case 0x94: printf("SUB   D"); break;
        case 0x95: printf("SUB   E"); break;
        case 0x96: printf("SUB   H"); break;
        case 0x97: printf("SUB   L"); break;
